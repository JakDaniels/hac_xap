...
#ifndef _LIBDMX485_H_
#define _LIBDMX485_H_
...
typedef struct {
	...
	int actual_rate;		// the actual baud rate acheived
} dmx_state;
...
/*
 * Opens the specified RS-485 device (i.e. /dev/ttyUSB0), initializes it for
 * DMX operation, and returns its file descriptor in the passed status structure.
